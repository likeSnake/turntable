...
public class MainActivity extends AppCompatActivity {
    ...
    private void initFragment() {
        TurntableFragment mHomeFragment = new TurntableFragment(this);
        DiceFragment mPlanFragment = new DiceFragment(this);
        CoinsFragment mGameFragment = new CoinsFragment(this);
        RandomFragment randomFragment = new RandomFragment(this);
        SettingFragment mSettingFragment = new SettingFragment(this);
